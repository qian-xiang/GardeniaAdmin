...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        <!-- 内容主体区域 -->
        <div id="toolbar">
    <?php echo build_toolbar_btn('add,del'); ?>
...
<table id="table"></table>
        ...
        <?php 
            $controllerJs = './static/js/backend/'.\think\helper\Str::snake(request()->controller()).'.js';
