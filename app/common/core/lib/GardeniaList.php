...
class GardeniaList
{
    ...
    public function setTableOptions($attr,$value) {
        $this->tableOptions[$attr] = $value;
        return $this;
    }
    public function setTableOptionsBatch($options) {
...
//            'layuiTemplateList' => $this->layuiTemplateList,
        ...
        \view('../../common/core/tpl/body',$subArray)->send();
//        $mainArray = [
//            'display_type'=> 'list',
